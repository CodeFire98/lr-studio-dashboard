...
const Icon = ({ name, size = 16, stroke = 1.6, ...rest }) => {
  ...
  switch (name) {
    ...
    case "edit": return (<svg {...common}><path d="M12 20h9"/><path d="M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z"/></svg>);
    ...
    // Billing — a stylised receipt/invoice with three lines.
    case "receipt": return (<svg {...common}><path d="M6 3h12v18l-3-2-3 2-3-2-3 2z"/><path d="M9 8h6M9 12h6M9 16h4"/></svg>);
