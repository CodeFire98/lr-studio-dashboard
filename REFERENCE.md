...
**Last updated:** 2026-05-07 ("Posted" terminal state via `post_plan_publications` table — derived from approved + has-publication-row, not a 4th status enum value; new `/c/:slug/posts` Live posts repository view with sidebar nav)
