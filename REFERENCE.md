...
**Last updated:** 2026-05-21 (**Remove dead agency "Add a client" / "Manage clients" buttons from BrandPicker + fix two adjacent nav/banner bugs surfaced during testing.** Three bundled changes in the same brand-picker-area touch.
